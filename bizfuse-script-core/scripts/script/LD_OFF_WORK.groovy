...
def MAIL_TITLE = "下班打卡通知"
def CHK_SUCCESS = "下班打卡成功"
def CHK_FAILD = "下班打卡失败"
...
if(authReq.status=="success"){
	...
	def offWorkReq = doPost("/oa/m/attendanceLogs",["locationDTO":["locationName":"河北省环保厅","locationDetail":"106","latitude":38.040978,"longitude":114.470548],"equipment":"MX6","commutingType":"OFFWORK","baseLocationSettingId":11,"attDate":time])
